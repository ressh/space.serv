...
<div class="content">
    ...
    <span class="btn_summ button button-circle button-primary" name="5">5 руб.</span>
    <span class="btn_summ button button-circle button-caution" name="10">10 руб.</span>
    <span class="btn_summ button button-circle button-primary" name="25">25 руб.</span>
    <span class="btn_summ button button-circle button-primary" name="50">50 руб.</span>
    <span class="btn_summ button button-circle button-primary" name="100">100 руб.</span>
    <span class="btn_summ button button-circle button-primary" name="250">250 руб.</span>
    <span class="btn_summ button button-circle button-primary" name="500">500 руб.</span>
    ...
    <span class="btn_money_type button button-pill button-caution"
          name="0"> Баланс для покупок ( <?= $player->getSummBuy() ?> руб. )</span>
    <span class="btn_money_type button button-pill button-primary"
          name="1"> Доступный баланс ( <?= $player->getSummLimit() ?> руб. )</span>
