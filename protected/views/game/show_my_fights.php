            ...
            <tr style="color:#ffffff;">
                ...
                <td>
                    <? if ($game->winner_id == $player->id): ?>
                        <a href="<?= $this->createUrl( 'game/getMoneyWin', array( 'id'=>$game->id ) ) ?>" class="btn btn-success">Забрать приз <?= $game->getMoneyWin(); ?> руб.</a>
                    <? elseif( $game->winner_id == 0 ): ?>
                        <a href="<?= $this->createUrl( 'game/getMoneyNothin', array( 'id'=>$game->id ) ) ?>" class="btn btn-info">Забрать ставку <?= $game->summ ?> руб.</a>
                    <? else: ?>
