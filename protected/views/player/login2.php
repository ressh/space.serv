...
<div class="contanier_regist content">
    ...
    <div class="form" style="">
        ...
        <div style="text-align: center; background: #000000; padding: 5px;">или вход через соц сети (вы соглашаетесь с <a target="_blank" href="<?= $this->createUrl( 'site/rulesGame' ) ?>">правилами игры</a> и тем что вам есть 18 лет)</div>
