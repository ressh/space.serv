...
<div class="contanier_regist content">
    ...
    <div class="form" style="">
        ...
        <div style="background: #000000; padding: 15px; text-align: center; color:#ffffff;">
            Нажимая на кнопку регистрация или вход через соц. сети, вы соглашаетесь с тем, что Вам есть 18 лет и Вы сгласны с <a target="_blank" href="<?= $this->createUrl( 'site/rulesGame' ) ?>">правилами игры</a>
        </div>
