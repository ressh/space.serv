...
function startPlay()
{
    ...
    setDialog( $('.stantion'), 'Спасибо за груз командир! Куда теперь?', 1, 4000 );
    setDialog( $('.player'), 'Созвездие Льва, дружище!', 4000, 3000 );
    setDialog( $('.stantion'), 'Баки заполнены, удачной дороги!', 10000, 4000 );
    setDialog( $('.player'), 'Спасибо, увидимся!', 14000, 3000 );
